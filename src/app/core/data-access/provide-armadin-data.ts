...
import {
  PreviewAuthData,
  PreviewVehicleData,
  PreviewRegulationData,
  PreviewSparepartData,
  PreviewDriverData,
  PreviewChecklistData,
...
/**
 * Provides ARMADIN data adapters with switching based on `environment.previewMode`.
 *
 ...
 */
export function provideArmadinData(): EnvironmentProviders {
  return makeEnvironmentProviders([
    ...
    {
      provide: REGULATION_DATA,
      useFactory: chooseAdapter<PreviewRegulationData, ApiRegulationData>(),
      deps: [APP_ENV, PreviewRegulationData, ApiRegulationData],
    },
    {
      provide: SPAREPART_DATA,
      useFactory: chooseAdapter<PreviewSparepartData, ApiSparepartData>(),
      deps: [APP_ENV, PreviewSparepartData, ApiSparepartData],
    },
    {
      provide: DRIVER_DATA,
      useFactory: chooseAdapter<PreviewDriverData, ApiDriverData>(),
      deps: [APP_ENV, PreviewDriverData, ApiDriverData],
    },
    {
      provide: CHECKLIST_DATA,
      useFactory: chooseAdapter<PreviewChecklistData, ApiChecklistData>(),
      deps: [APP_ENV, PreviewChecklistData, ApiChecklistData],
    },
    {
    ...
    {
      provide: FUEL_DATA,
      useFactory: chooseAdapter<PreviewFuelData, ApiFuelData>(),
      deps: [APP_ENV, PreviewFuelData, ApiFuelData],
    },
    {
      provide: SPJ_DATA,
      useFactory: chooseAdapter<PreviewSpjData, ApiSpjData>(),
      deps: [APP_ENV, PreviewSpjData, ApiSpjData],
    },
    {
      provide: IMAGE_DATA,
